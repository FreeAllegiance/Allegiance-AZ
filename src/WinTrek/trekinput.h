...
public:
	...
	virtual void		 ClearButtonStates(bool reloadKeyMap)									   = 0; // yp - Your_Persona allow for clearButtonStates.(buttons get stuck patch) aug-03-2006  // BT - 8/17 Stuck button/Throttle Bounce
